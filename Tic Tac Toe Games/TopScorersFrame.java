...
/**
 * Represents the top scorers display window for the Tic-Tac-Toe application.
 * Retrieves and displays the top 5 players ranked by score in a styled table,
 * including each player's wins, losses, draws, and total score.
 *
...
public class TopScorersFrame extends JFrame {
    ...
    /**
     * Constructs a new TopScorersFrame and initializes the leaderboard UI.
     * Fetches the top 5 players from the database via {@link PlayerService},
     * populates a table with rank medals, usernames, and game statistics,
     * and provides a close button to dismiss the window.
     */
