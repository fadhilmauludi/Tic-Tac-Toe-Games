...
/**
 * Represents the main menu window of the Tic-Tac-Toe application.
 * Displays navigation buttons for starting a game, viewing statistics,
 * viewing top scorers, and exiting the application.
 *
...
public class MainMenuFrame extends JFrame {
    ...
    /**
     * Constructs a new MainMenuFrame for the given player.
     * Initializes the menu UI with a welcome header, navigation buttons
     * (start game, statistics, top scorers, exit), and the player's current score display.
     *
     * @param player the currently logged-in {@link Player} whose session is active
     */
    ...
    /**
     * Creates a styled menu button with consistent font, color, and cursor settings.
     *
     * @param text the label text to display on the button
     * @return a new {@link JButton} configured with the standard menu button style
     */
