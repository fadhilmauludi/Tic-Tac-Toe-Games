...
/**
 * Represents the login window for the Tic-Tac-Toe application.
 * Provides a form with username and password fields for player authentication.
 * Upon successful login, the player is redirected to the main menu.
 *
...
public class LoginFrame extends JFrame {
    ...
    /**
     * Constructs a new LoginFrame and initializes the login user interface.
     * Sets up the title label, username and password input fields, and the login button.
     * Also registers action listeners for the login button and the Enter key on the password field.
     */
    public LoginFrame() {
    ...
    /**
     * Handles the login action when the login button is clicked or Enter is pressed.
     * Validates that the username and password fields are not empty, then attempts
     * authentication via {@link PlayerService}. On success, opens the {@link MainMenuFrame}
     * and disposes of this window. On failure, displays an error message and clears the password field.
     */
